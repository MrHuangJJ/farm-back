...
public class HomeworkSeasonController {
    ...
    @ResponseBody
    public Map<String,Object> addHomeworkSeason(HomeworkSeason homeworkSeason){
    ...
    @ResponseBody
    public Map<String,Object> listHomeworkSeason(String years,String hs_grouping,String hs_type,String hs_beginTime,String hs_endTime,int page, int limit){
        if (years!=null && years!=""){
            hs_beginTime=years+"-01-01";
            hs_endTime=years+"-12-31";
        }
        int sum=(page-1)*limit;
        int count=homeworkSeasonService.endPageListHomeworkSeason(hs_grouping,hs_type,hs_beginTime,hs_endTime);
        List<HomeworkSeason> homeworkSeasons = homeworkSeasonService.listHomeworkSeason(hs_grouping,hs_type,hs_beginTime,hs_endTime,sum,limit);
        Map<String,Object> map=new HashMap<String,Object>();
        map.put("code", 0);
        map.put("msg", "");
        map.put("count", count);
